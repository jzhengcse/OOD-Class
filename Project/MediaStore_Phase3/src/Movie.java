...
//	}
	...
	public String toString() {
		String fs;
		fs=String.format("Name: %s  %nDirector: %s  %nTime: %s  %nGenre: %s  %nAverage Ranking: %d  %nPrice: %.2f %nNumberSold: %d  %nRating: %.2f  %nYear of release: %d",name,author,time,genre,rank,price,soldNum,rate,yearOfRelease);
		return fs;
