...
public class Music extends Media{
	...
	public String toString() {
		...
		String fs;
		fs=String.format("Name: %s  %nArtist: %s  %nTime: %s  %nGenre: %s  %nAverage Ranking: %d  %nPrice: %.2f  %nNumberSold: %d  %nRating: %.2f",name,author,time,genre,rank,price,soldNum,rate);
		return fs;
